...
from selenext_dialog import selenextDialog
import os.path
...
class selenext:
    ...
    def __init__(self, iface):
        ...
        self.dlg = selenextDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&selenext')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'selenext')
        self.toolbar.setObjectName(u'selenext')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('selenext', message)
